...
1️⃣ Sales Dashboard (Power BI) - Built interactive dashboard - Used DAX measures - Analyzed monthly revenue trends,

2️⃣ Customer & Orders SQL Project - Created relational database - Performed INNER JOIN, LEFT JOIN - Analyzed customer spending behavior,
